...
mdadm --stop /dev/md/raid_root &> /dev/null || true
mdadm --stop /dev/md/raid_boot &> /dev/null || true
mdadm --stop /dev/md/raid_efi &> /dev/null || true
mdadm --stop /dev/md/raid &> /dev/null || true
mdadm --stop /dev/md* &> /dev/null || true